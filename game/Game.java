...
public class Game{
  ...
  public boolean playGeneticAlgorithm()
  {
	    int fails = 0;
	    int leader = (rand.nextInt(numPlayers));
	    for(int round = 1; round<=5; round++){
  ...
  public static void main(String[] args){
    Game g = new Game();
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'A');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'B');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'C');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'D');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'E');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'F');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'G');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'H');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'I');
    g.stopwatchOn();g.addPlayer(new ComboAgent(5,5,5,(float) 0.5,5,5,5,5,5,5,5));g.stopwatchOff(1000,'J');
    g.setup();
    g.playGeneticAlgorithm();
  }
}  
